...
logger = logging.getLogger('casauth.db.sqlalchemy.migration')
...
def db_version(options, repo_path=None):
    ...
    try:
        ...
        raise cas_exc.DatabaseMigrationError(msg)
...
def db_sync(options, version=None, repo_path=None):
    ...
    :param options: options dict
    :param repo_path: used for plugin db migrate_repo, defaults to main repo
    :retval version number
