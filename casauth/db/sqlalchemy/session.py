...
from casauth.db.sqlalchemy import mappers
...
def _create_facade(options):
    ...
    # TODO(khanhct): Refactor this once oslo.db spec is implemented:
    ...
    if _FACADE is None:
        with _LOCK:
            if _FACADE is None:
                ...
                # TODO(khanhct): once query_log is removed,
