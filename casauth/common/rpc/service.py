...
from casauth.common.rpc import secure_serializer as ssz
from casauth.taskmanager.managers import PeriodicTaskManager, UserManager
...
class RpcService(service.Service):
    ...
    def __init__(self, key, host=None, binary=None, topic=None, manager=None,
        ...
        self.topic = topic or self.binary.rpartition('casauth-')[2]
    ...
    def start(self):
        ...
        user_endpoint = UserManager()
        endpoints = [periodic_endpoint, user_endpoint]
        ...
        # TODO(khanhct): Currently the context is none... do we _need_ it here?
